# ContentForge v3.21.0 — Complete User Guide
...
**ContentForge v3.21.0** — 13 agents, 22 skills, 8 built-in content types, 10 industry knowledge packs, 41-pattern AI-detection humanizer, three-layer fact verification.
