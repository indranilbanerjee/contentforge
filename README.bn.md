...
> **ইংরেজি README v4.1.1 (2026-08-17)-এর সঙ্গে সিঙ্ক করা।** [ইংরেজি README](README.md)-ই সত্যের একমাত্র উৎস — রিলিজ নোট, স্কিল ও কমান্ডের পূর্ণাঙ্গ ক্যাটালগ, আর্কিটেকচার, ট্রাবলশুটিং এবং সম্পূর্ণ FAQ সেখানেই রয়েছে। ContentForge ইনস্টল, চালানো ও আপডেট করতে যা যা লাগে, তার সবই এই অনুবাদে পাবেন।
...
**ভার্সন 4.1.1** · [চেঞ্জলগ](CHANGELOG.md) · MIT লাইসেন্স · [প্রজেক্টটি স্পনসর করুন ❤](https://github.com/sponsors/indranilbanerjee)
