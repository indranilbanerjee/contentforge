"""ContentForge Hermes Agent adapter tests."""
...
class TestHermesPluginYaml(unittest.TestCase):
    ...
    def test_required_name(self):
        self.assertEqual(_read_yaml_field(self.yaml_text, "name"), "contentforge")
...
class TestHermesAdapter(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        spec = importlib.util.spec_from_file_location("cf_hermes_adapter", ADAPTER_PY)
    ...
    def test_audit_works(self):
        ...
        self.assertGreater(result["skill_count"], 15)
    ...
    def test_register_against_mock_ctx(self):
        ...
        self.assertGreater(len(registered), 15)
