...
skills/agents/commands/*.md and therefore missed live violations in docs/, utilities/ and scripts/.
"""
import re
import unittest
...
SIBLING_PATTERN = re.compile(
    r"digital-marketing-pro|digital marketing pro|socialforge|social-forge", re.IGNORECASE
)
...
EXTENDED_DIRS = ("docs", "scripts", "utilities", "utils", "templates", "config")
ROOT_FILES = ("AGENTS.md", "CONTRIBUTING.md", "SUBMISSION.md", "TESTING-GUIDE.md",
    "CONNECTORS.md", "SECURITY.md", "COWORK-GUIDE.md", "UPGRADE-GUIDE.md",
    "ContentForge-PRD-Blueprint.md",)
