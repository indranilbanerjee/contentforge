# ContentForge Testing Guide — v3.6.0
...
- [ ] ContentForge listed with version 3.6.0
...
| 19 | `/cf:help` | (no argument) | Shows v3.6.0, 13 agents, 19 skills, 7 connectors, 10-phase pipeline |
...
- [ ] `plugin.json` version = 3.6.0
- [ ] `hooks.json` version string = v3.5
- [ ] `README.md` version = 3.6.0
- [ ] Marketplace entry version = 3.6.0
...
| 3 | Brand setup (all steps A-G) | 4.1 | Validates v3.6.0 Steps F + G |
